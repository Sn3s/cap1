...
class _MotivationGoalsSummary extends StatelessWidget {
  const _MotivationGoalsSummary({required this.state, required this.motivation});
  final AppState state;
      ...
      child: Column(
        ...
        children: [
          const Text(
            ...
            style: TextStyle(
                color: _body, fontSize: 12.5, height: 1.4, fontWeight: FontWeight.w700),
          ),
          const SizedBox(height: 14),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _AiInsightNote(
              trend:
                  month.canPayBills ? _InsightTrend.up : _InsightTrend.down,
...
String _actionInsight(_CashActionScore action, List<_ActionMeasure> measures) {
  ...
  final detail = switch (lowest.$1) {
    ...
    _ => "the target has been hard to hold onto some weeks, even with partial progress.",
  };
...
Set<String> _adoptedMotivations(AppState state) {
  return {
    for (final entry in _motivationGoalIds.entries)
      if (entry.value.any((goalId) => isGoalAdopted(state, goalId)))
        entry.key,
  };
}
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton.icon(
                onPressed: () => _push(context, const AddGoalMotivationScreen()),
