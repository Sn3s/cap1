...
void main() {
  ...
  final screens = <({String name, Widget widget})>[
    ...
    (name: '07_preparation_orient', widget: const PreparationOrientScreen()),
    (name: '08_financial_concern', widget: const FinancialConcernScreen()),
    (name: '09_motivation_surface', widget: const MotivationSurfaceScreen()),
    (name: '10_goal_questionnaire', widget: const GoalQuestionnaireScreen()),
    (name: '11_recommended_plan', widget: const RecommendedPlanScreen()),
    (name: '12_app_permission', widget: const AppPermissionScreen()),
    (
      name: '13_personal_data_consent',
      widget: const PersonalDataConsentScreen(),
    ),
    (
      name: '14_data_retention_consent',
      widget: const DataRetentionConsentScreen(),
    ),
    (name: '15_financial_baseline', widget: const FinancialBaselineScreen()),
    (name: '16_tracking_variables', widget: const TrackingVariablesScreen()),
    (name: '17_goal_feasibility', widget: const GoalFeasibilityScreen()),
    (name: '18_pyramid_preview', widget: const PyramidPreviewScreen()),
    (name: '19_consent_privacy', widget: const ConsentPrivacyScreen()),
    (name: '20_social_structure', widget: const SocialStructureScreen()),
    (
      name: '21_preparation_commitment',
      widget: const PreparationCommitmentScreen(),
    ),
    (
      name: '22_first_collection_handoff',
      widget: const FirstCollectionHandoffScreen(),
    ),
    (name: '23_home_dashboard', widget: const DashboardPage()),
    (name: '24_home_insights', widget: const InsightsPage()),
    (name: '25_home_goals', widget: const GoalsPage()),
    (name: '26_home_activity', widget: const ActivityPage()),
    (name: '27_home_you', widget: const ProfilePage()),
    (name: '28_user_selections', widget: const UserSelectionsScreen()),
    (name: '29_legacy_discovery', widget: const DiscoveryScreen()),
    (name: '30_legacy_quantitative', widget: const QuantitativeScreen()),
    (name: '31_legacy_feasibility', widget: const FeasibilityScreen()),
  ];
